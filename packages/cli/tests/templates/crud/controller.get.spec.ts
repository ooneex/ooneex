...
describe("controller.get.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.get.txt");
...
describe("controller.get.test.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.get.test.txt");
...
describe("route.type.get.txt", () => {
  const templatePath = join(templatesDir, "crud", "route.type.get.txt");
