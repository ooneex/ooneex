...
## [0.5.2](https://github.com/ooneex/ooneex/releases/tag/@ooneex/command@0.5.2) - 2026-04-12
...
- Default to help command when no command name provided — Franck ([ae35c7d2](https://github.com/ooneex/ooneex/commit/ae35c7d2))
...
- Add commandCreate helper and move command templates to command package — Franck ([f9a06170](https://github.com/ooneex/ooneex/commit/f9a06170))
