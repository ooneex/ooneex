...
describe("controller.filter.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.filter.txt");
...
describe("controller.filter.test.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.filter.test.txt");
...
describe("route.type.filter.txt", () => {
  const templatePath = join(templatesDir, "crud", "route.type.filter.txt");
