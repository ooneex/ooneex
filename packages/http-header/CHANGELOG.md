...
## [1.2.12](https://github.com/ooneex/ooneex/releases/tag/@ooneex/http-header@1.2.12) - 2026-04-12

### Changed

- Bump package versions and fix description dashes — Franck ([78bf3699](https://github.com/ooneex/ooneex/commit/78bf3699))

## [1.2.10](https://github.com/ooneex/ooneex/releases/tag/@ooneex/http-header@1.2.10) - 2026-04-09

### Changed

- Change workspace deps from workspace:* to workspace:^ — Franck ([3580f92c](https://github.com/ooneex/ooneex/commit/3580f92c))
...
## [1.2.5](https://github.com/ooneex/ooneex/releases/tag/@ooneex/http-header@1.2.5) - 2026-04-07

### Changed

- @ooneex/http-header@1.2.4 — Franck ([f89290fc](https://github.com/ooneex/ooneex/commit/f89290fc))
- Add @types/bun to tsconfig types across all packages — Franck ([6faa8fe0](https://github.com/ooneex/ooneex/commit/6faa8fe0))

## [1.2.4](https://github.com/ooneex/ooneex/releases/tag/@ooneex/http-header@1.2.4) - 2026-04-07

### Changed

- Add @types/bun to tsconfig types across all packages — Franck ([afd2c522](https://github.com/ooneex/ooneex/commit/afd2c522))

## [1.2.3](https://github.com/ooneex/ooneex/releases/tag/@ooneex/http-header@1.2.3) - 2026-04-01

### Changed

- Disable minification in bunup configs across all packages — Franck ([29f840e1](https://github.com/ooneex/ooneex/commit/29f840e1))

## [1.2.2](https://github.com/ooneex/ooneex/releases/tag/@ooneex/http-header@1.2.2) - 2026-03-29
