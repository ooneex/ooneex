...
describe("AiException", () => {
  ...
  test("should create AiException with message and data", () => {
    ...
    const exception = new AiException(message, data);
  ...
  test("should have immutable data property", () => {
    ...
    const exception = new AiException("Test message", data);
  ...
  test("should maintain proper stack trace", () => {
    function throwAiException() {
      throw new AiException("Stack trace test");
    }
