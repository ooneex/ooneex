...
describe("DirectoryException", () => {
  describe("constructor", () => {
    test("should create an instance with message only", () => {
      const exception = new DirectoryException("Directory not found");
    ...
    test("should create an instance with message and data", () => {
      ...
      const exception = new DirectoryException("Failed to create directory", data);
      expect(exception).toBeInstanceOf(DirectoryException);
    });
  });
  ...
  describe("message", () => {
    test("should have correct message", () => {
      const exception = new DirectoryException("Custom error message");
      expect(exception.message).toBe("Custom error message");
    });

    test("should handle empty message", () => {
      const exception = new DirectoryException("");
  ...
  describe("data", () => {
    ...
    test("should not allow data modification", () => {
      const exception = new DirectoryException("Test", { key: "value" });
      expect(() => {
  ...
  describe("inheritance", () => {
    test("should be throwable", () => {
      expect(() => {
        throw new DirectoryException("Test error");
    ...
    test("should work with try-catch pattern", () => {
      let caught = false;
      try {
        throw new DirectoryException("Operation failed", { path: "/test" });
      } catch (error) {
