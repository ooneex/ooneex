...
describe("AiException", () => {
  ...
  test("should create AiException with message only", () => {
    ...
    const exception = new AiException(message, "PROCESSING_FAILED");
  ...
  test("should create AiException with message and data", () => {
    ...
    const exception = new AiException(message, "PROCESSING_FAILED", data);
  ...
  test("should inherit all properties from Exception", () => {
    ...
    const exception = new AiException(message, "TEST", data);
  ...
  test("should maintain proper stack trace", () => {
    function throwAiException() {
      throw new AiException("Stack trace test", "TEST");
    }
