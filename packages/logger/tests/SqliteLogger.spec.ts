...
// Recreate the SqliteLogger class locally for testing to avoid triggering
// the @decorator.logger() which causes DI container registration issues
// with the optional constructor parameter
class SqliteLogger implements ILogger<LogsEntity> {
