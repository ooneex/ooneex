...
# Migration 3: images_comments
cat > Migration20251225181613484.ts << 'EOF'
import { type IMigration, type MigrationClassType, decorator } from "@ooneex/migrations";
...
export class Migration20251225181613484 implements IMigration {
  ...
  public getDependencies(): MigrationClassType[] {
    return [
      Migration20251225181613479,
    ];
  }
}
EOF

# Migration 4: images_liked
cat > Migration20251225181613486.ts << 'EOF'
import { type IMigration, type MigrationClassType, decorator } from "@ooneex/migrations";
import type { TransactionSQL } from "bun";
import { Migration20251225181613479 } from "./Migration20251225181613479";
...
echo "Created 2 migration files"
