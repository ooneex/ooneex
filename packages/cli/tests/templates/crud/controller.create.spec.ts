...
describe("controller.create.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.create.txt");
...
describe("controller.create.test.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.create.test.txt");
...
describe("route.type.create.txt", () => {
  const templatePath = join(templatesDir, "crud", "route.type.create.txt");
