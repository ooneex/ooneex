...
describe("decorator.storage", () => {
  ...
  test("should throw ContainerException for class not ending with 'Storage'", () => {
    class InvalidBucket implements IStorage {
      public setBucket(): IStorage {
        return this;
      }
      public async list(): Promise<string[]> {
  ...
  test("should throw ContainerException with correct message for invalid class name", () => {
    ...
    expect(() => {
      decorator.storage()(WrongNaming);
    }).toThrow('Class name "WrongNaming" must end with "Storage"');
  });

  test("should throw for class name containing 'Storage' but not ending with it", () => {
    ...
    expect(() => {
      decorator.storage()(StorageManager);
    }).toThrow(ContainerException);
  });

  test("should throw for class name ending with lowercase 'storage'", () => {
    class Teststorage implements IStorage {
      public setBucket(): IStorage {
        return this;
      }
