...
describe("controller.update.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.update.txt");
...
describe("controller.update.test.txt", () => {
  const templatePath = join(templatesDir, "crud", "controller.update.test.txt");
...
describe("route.type.update.txt", () => {
  const templatePath = join(templatesDir, "crud", "route.type.update.txt");
